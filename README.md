...
[![install size](https://packagephobia.now.sh/badge?p=@kronos-integration/service-systemd/@2.5.6)](https://packagephobia.now.sh/result?p=@kronos-integration/service-systemd@2.5.6)
